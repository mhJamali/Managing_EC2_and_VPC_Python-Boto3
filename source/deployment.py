from source.ec2.vpc import VPC
from source.ec2.ec2 import EC2
from source.client_locator import EC2Client
...
def main():
    ...
    vpc.add_tags(public_subnet_id, 'my-Public-Subnet')
    ...
    vpc.add_tags(private_subnet_id, 'my-Private-Subnet')

    # EC2 Instances
    ec2 = EC2(ec2_client)

    # Create a key pair
    key_pair_name = 'Boto3_KeyPair'
    ...
    ami_id = 'ami-015232c01a82b847a'   # ami for amazon linux
...
def modify_instance():
    ...
    ec2.modify_ec2_instance('i-01560b6cd12a884b1')
...
def stop_instance():
    ...
    ec2.stop_instance('i-01560b6cd12a884b1')
...
def start_instance():
    ...
    ec2.start_instance('i-01560b6cd12a884b1')
...
def terminate_instance():
    ...
    ec2.terminate_instance('i-01560b6cd12a884b1')
